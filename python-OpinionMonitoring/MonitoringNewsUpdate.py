...
import sys
import json
from  SpiderModelPackage import TencentNewsChengDuSpiderMoudel
...
if  __name__ == '__main__':
    ...
    spiderTencentNews = TencentNewsChengDuSpiderMoudel.TencentNewsChengDuSpider(TencentNewsPageSeedUrl)
